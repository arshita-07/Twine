...
#Function used in generation of round key from and 80 or 128 bit key and in encryption
...
def _key_schedule_80(key):
    ...
    for r in range(1, 36):
        ...
        #_S(Wk_80[index]) returns the S box mapping for that element which is then computed with another value from the key dictionary under XOR operation
        WK_80[1] = WK_80[1] ^ _S(WK_80[0])
        WK_80[4] = WK_80[4] ^ _S(WK_80[16])
        #_CON_H and #_CON_L return 3 bit binary literals after right shift of the element from the CON martix and performing bit-wise and
        ...
        #assigning WK0_to_WK3_16 back to WK_80
        ...
        #assigning WK0_to_WK19_80 back to WK_80
